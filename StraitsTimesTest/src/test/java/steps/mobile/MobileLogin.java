...
public class MobileLogin extends base.BaseUtil {
    ...
    public void iEnteredValidLoginIdAndPassword(String loginId, String password) throws Throwable {
        //WebDriverWait wait = new WebDriverWait(base.androidDriver, 10);
        //wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@name='j_username']")));
        //base.androidDriver.findElement(By.xpath("//input[@name='j_username']")).sendKeys(loginId);
        //base.androidDriver.findElement(By.xpath("//input[@name='j_password']")).sendKeys(password);
        //base.androidDriver.findElement(By.xpath("//button[@type='submit']")).click();
    ...
    public void iShouldSeeMyLoginIdAndLogoutHyperlinkOnTopRight(String loginId) throws Throwable {
        ...
        base.androidDriver.findElement(By.xpath("//a[text()='Logout']"));
        */
    }
    ...
    public void iShouldSeeEitherImageOrVideoPresentInMainArticle() throws Throwable {
        ...
        try
        {
            base.androidDriver.findElement(By.xpath("//div[@class='pane-content']//img"));
        ...
        if(!isMediaElementFound)
        {
            ...
            //base.androidDriver.findElement(By.xpath("//div[@class='pane-content']//video"));
        }
        */
    }
    ...
    public void iClickOnTheMainArticle() throws Throwable {
        //base.androidDriver.findElement(By.xpath("//a[@class='block-link']")).click();
    }

    @Then("^the main article page will be loaded$")
    public void theMainArticlePageWillBeLoaded() throws Throwable {

        //base.androidDriver.findElement(By.xpath("//h1[@class='headline node-title']")).click();
    }
    ...
    public void pictureOrVideoIsPresentInTheArticle() throws Throwable {
        ...
        try
        {
            base.androidDriver.findElement(By.xpath("//div[@class='media-group fadecount0'] //img[@class='img-responsive']"));
            isMediaElementFound = true;
        }catch (NoSuchElementException e){}

        if(!isMediaElementFound)
        {
            base.androidDriver.findElement(By.xpath("//body[@class='-display']//video[@class='vjs-tech']"));
        }
        */
    }
